...
import profpic from "../assets/robotLogo.jpg"
import taskimg from "../assets/taskimgd.png"
  ...
  return (
    <div className='maincontent'>
        ...
        <div className='leftcontent'>
            ...
            <h3>Hey {name},There is your way {name} ! </h3>
           
            <img src={taskimg} alt="" className='taskimg'/>
            <p>Everything is real until it is divisible enough to be reached </p>
        </div>
